...
void CasmIRToCselIRPass::usage( libpass::PassUsage& pu )
{
    pu.require< libcasm_ir::ConsistencyCheckPass >();
}

u1 CasmIRToCselIRPass::run( libpass::PassResult& pr )
{
...
//     // libcsel_ir::SequentialScope* scope = new
...
//     //     libcsel_ir::Reference::LINKAGE );
//     // ic_ref->setRef< libcsel_ir::Interconnect >(
...
//     // // libcsel_ir::CastInstruction* cast = new
//     libcsel_ir::CastInstruction(
...
//     //     // libcsel_ir::Instruction* u_ca = new
//     libcsel_ir::CastInstruction(
//     //     // update_type, u_el );
...
//     //     libcsel_ir::Instruction* f_val = new
//     libcsel_ir::ExtractInstruction(
//     //         f_ref, f_ref->structure()->get( 0 ) );
//     //     libcsel_ir::Instruction* f_def = new
//     libcsel_ir::ExtractInstruction(
...
//     libcsel_ir::CallInstruction* last_call =
//     (libcsel_ir::CallInstruction*)last;
...
//     // assert( parent );
//     // libcsel_ir::Statement* stmt = (libcsel_ir::Statement*)m_reference[
//     parent
//     // ];
//     // assert( stmt );
//     // stmt->add( local );
...
//     // libcsel_ir::CallInstruction* call = new libcsel_ir::CallInstruction(
//     lup
//     // );
//     // assert( call );
...
//     // libcsel_ir::AllocInstruction* alloc = new
//     libcsel_ir::AllocInstruction(
...
//     // libcsel_ir::AllocInstruction* result = new
//     libcsel_ir::AllocInstruction(
